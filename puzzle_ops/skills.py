...
def _weekly_review_skill() -> BusinessSkillDefinition:
    return BusinessSkillDefinition(
        ...
        allowed_tools=("history.aggregate_metrics", "rag.retrieve.weekly_review", "memory.retrieve"),
        guarded_tools=(),
...
def _regular_demand_skill() -> BusinessSkillDefinition:
    return BusinessSkillDefinition(
        ...
        allowed_tools=("cms.query_inventory", "history.search_records", "image.retrieve_similar_good_bad", "rag.retrieve.value_master", "rag.retrieve.audit"),
...
def _trial_parse_skill() -> BusinessSkillDefinition:
    return BusinessSkillDefinition(
        ...
        allowed_tools=("image.extract_features", "image.retrieve_similar_good_bad", "rag.retrieve.value_master", "rag.retrieve.audit"),
        guarded_tools=("feishu.write_table", "cms.upload_asset"),
        rag_task_index="value_master",
        rag_source_types=("value_rule", "approved_value_rule", "approved_rag_patch", "audit_policy", "fact", "harness_gold_sample"),
        memory_read_layers=("facts", "long_term"),
...
def _value_audit_skill() -> BusinessSkillDefinition:
    return BusinessSkillDefinition(
        ...
        allowed_tools=("rag.retrieve.value_master", "rag.retrieve.audit", "memory.retrieve", "history.search_records", "audit.retrieve_policy"),
        guarded_tools=(),
        rag_task_index="value_master",
        rag_source_types=("value_rule", "approved_value_rule", "approved_rag_patch", "audit_policy", "fact", "harness_gold_sample"),
        memory_read_layers=("facts", "long_term"),
...
def _memory_governance_skill() -> BusinessSkillDefinition:
    return BusinessSkillDefinition(
        ...
        allowed_tools=("memory.workbench", "memory.conflicts", "memory.provenance", "memory.rag_stats", "rag.retrieve.memory_governance"),
        guarded_tools=(),
